...
STRING str_MetalDoorLocked,"Hmmm, a BIG metal door.";
STRING str_MetalDoorUnlocked,"Worked like a charm.";
...
STRING  str_SwitchDoorS2On,"Well, that just opened something BIG..";
STRING  str_SwitchDoorS2Off,"And now it closed something BIG.";
