...
BMAP  map_ZKidMove09,	<zmbk09.pcx>;
BMAP  map_ZKidMove10,	<zmbk10.pcx>;
BMAP  map_ZKidMove11,	<zmbk11.pcx>;
BMAP  map_ZKidMove12,	<zmbk12.pcx>;
...
BMAP  Boy01_map,	<Boy01.pcx>;
BMAP  Boy02_map,	<Boy02.pcx>;
BMAP  Boy03_map,	<Boy03.pcx>;
BMAP  Boy04_map,	<Boy04.pcx>;
...
//*******************************************************************
//*******************************************************************
BMAP  girl01_map,		<girl01.pcx>;
BMAP  girl02_map,		<girl02.pcx>;
BMAP  girl03_map,		<girl07.pcx>;
BMAP  girl04_map,		<girl15.pcx>;
...
{	SCALE_XY	24,24;	SIDES	2;CYCLES 4;
	...
	DELAY	3,3,3,3;
	FLAGS	sloop;
	//SOUND	snd_ZKidMove;	SCYCLE	1;	SVOL	1;	SDIST	10;	
	AMBIENT	.1;
}
Texture tex_ZKidHit 
{	SCALE_XY 	24,24;	CYCLES 4;
...
Texture tex_ZKidDie 
{	SCALE_XY 	24,24;	SIDES	1; CYCLES 3;
...
STRING str_ZKidDead, "The zombie is transformed.";
...
{	IF_EQUAL	MY.SKILL7,	0;	END;
	...
	RULE sk_dx = PLAYER_X - MY.X;
	RULE sk_dy = PLAYER_Y - MY.Y;
	RULE sk_Dist  = sk_dx*sk_dx + sk_dy*sk_dy;
	SQRT sk_Dist, sk_Dist;
	IF_BELOW 	sk_Dist,	15;	SET	MY.SPEED,	0;
	IF_ABOVE 	sk_Dist,	15;	SET	MY.SPEED,	MY.SKILL2;
...
{	TEXTURE		tex_ZKidStil;
	...
	SKILL5		25;		//maul range
	SKILL7		-1;		//maul damage
