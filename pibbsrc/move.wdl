...
PANEL	PibbFace01{PAN_MAP map_status_Pibb01;POS_X 145;POS_Y 0;FLAGS REFRESH, TRANSPARENT;}
PANEL	PibbFace02{PAN_MAP map_status_Pibb02;POS_X 145;POS_Y 0;FLAGS REFRESH, TRANSPARENT;}
PANEL	PibbFace03{PAN_MAP map_status_Pibb03;POS_X 145;POS_Y 0;FLAGS REFRESH, TRANSPARENT;}
PANEL	PibbFace04{PAN_MAP map_status_Pibb04;POS_X 145;POS_Y 0;FLAGS REFRESH, TRANSPARENT;}
PANEL	PibbFace05{PAN_MAP map_status_Pibb05;POS_X 145;POS_Y 0;FLAGS REFRESH, TRANSPARENT;}

SOUND	snd_feelgood	<beep.wav>;
...
# =====================================================================
SOUND	snd_face01,	<beep.wav>;
SOUND	snd_face02,	<beep.wav>;
SOUND	snd_face03,	<beep.wav>;
SOUND	snd_face04,	<beep.wav>;
SOUND	snd_face05,	<beep.wav>;
...
dead:	
	...
	RULE	sk_score = 100 * ( ((sk_ZombieKills/65)*0.5) + ((sk_PowerupCnt/33)*0.5) - ((sk_FriendKills/65)*0.25) );
