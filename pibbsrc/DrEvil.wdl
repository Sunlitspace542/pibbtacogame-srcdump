...
{	RULE		MY.SPEED 	= MY.SKILL2 * 1.0;
	...
	SET		MY.EACH_CYCLE,	act_DESpewFlare;
...
//*******************************************************
//*******************************************************
ACTION act_DESpewFlare
{	SET		skFlare_A,	MY.ANGLE;
	RULE		skFlare_X = 	MY.X;
	RULE		skFlare_Y = 	MY.Y;
	RULE		skFlare_H = 	MY.Height + 3.2;
	SET		actor_flare.INVISIBLE, 0;
	SET		actor_flare.EACH_TICK, act_initflare;
}
