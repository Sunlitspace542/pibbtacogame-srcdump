...
BMAP  map_TeacherMath01,	<Math01.pcx>;
BMAP  map_TeacherMath02,	<Math02.pcx>;
BMAP  map_TeacherMath03,	<Math03.pcx>;
BMAP  map_TeacherMath04,	<Math04.pcx>;
BMAP  map_TeacherMath05,	<Math05.pcx>;
...
//*******************************************************************
//*******************************************************************
BMAP  map_TeacherEng01,	<Eng01.pcx>;
BMAP  map_TeacherEng02,	<Eng02.pcx>;
BMAP  map_TeacherEng03,	<Eng03.pcx>;
BMAP  map_TeacherEng04,	<Eng04.pcx>;
...
Texture tex_ZStil 
{	SCALE_XY	24,24;	SIDES	1;CYCLES 4;
...
STRING str_ZombieDead, "The zombie is transformed.";
...
{	TEXTURE		tex_ZStil;
	...
	SKILL5		15;		//maul range
	SKILL7		-2;		//maul damage
